...
Am_Double_Data::operator double() const { return value; }

Am_Double_Data::Am_Double_Data(double in_value) { value = in_value; }

void
Am_Double_Data::Print(std::ostream &out) const
{
  out << value;
}
...
Am_String_Data::operator const char *() const { return value; }

Am_String_Data::operator char *() const { return (char *)value; }
...
const char *
Am_String_Data::To_String() const
{
  return value;
}

Am_Value
Am_String_Data::From_String(const char *string) const
{
  Am_Value v(string);
  return v;
}
