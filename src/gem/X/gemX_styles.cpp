...
Am_Style_Data::Am_Style_Data(int percent, Am_Fill_Solid_Flag fill_flag)
    : color_name(0L), main_display(0), color_head(0L), color_allocated(true),
      ...
      fill_solid(fill_flag), fill_poly(Am_FILL_POLY_EVEN_ODD),
...
Am_Style_Data::Am_Style_Data(Am_Style_Data *proto, Am_Style_Data *new_color)
    : main_display(0), color_head(0L),
      ...
      cap_style(proto->cap_style), join_style(proto->join_style),
      line_solid(proto->line_solid), dash_list_length(proto->dash_list_length),
      fill_solid(proto->fill_solid), fill_poly(proto->fill_poly),
...
void
Am_Style_Data::remove(Display *display)
{
  Am_Style_Data *curr;
...
unsigned long
Am_Style_Data::Get_X_Index(const Am_Drawonable_Impl *d)
{
...
XColor
Am_Style_Data::Get_X_Color(const Am_Drawonable_Impl *d)
{
...
void
Am_Style_Data::Add_Color_Index(Display *display, XColor index)
{
