...
short
get_graphical_line_thickness(Am_Style ls)
{
  if (ls == Am_No_Style)
    return 0;
  else {
...
inline void
Am_Drawonable_Impl::adjust_pen_stipple(const Am_Image_Array &fill_stipple)
{
  static Pattern pat;
...
inline void
adjust_pen_drawfn(Am_Draw_Function f, Am_Fill_Solid_Flag fill_flag)
{
...
inline void
adjust_pen_thickness(Am_Style ls)
{
...
//
void
Am_Drawonable_Impl::set_pen_using_fill(const Am_Style &fill, Am_Draw_Function f,
...
void
Am_Drawonable_Impl::set_pen_using_line(const Am_Style &line, Am_Draw_Function f)
{
  static const RGBColor *fore_color;
...
void
Am_Drawonable_Impl::set_fore_color(const Am_Style &style)
{
...
void
Am_Drawonable_Impl::set_back_color(const Am_Style &style)
{
  Am_Style_Data *style_data = Am_Style_Data::Narrow(style);
  if (style_data) {
    const RGBColor *fore_color = style_data->Get_Mac_Color(this);
 ...
 */
void
Am_Drawonable_Impl::Set_Clip(int left, int top, unsigned int width,
                             unsigned int height)
{
 ...
 */
void
Am_Drawonable_Impl::Push_Clip(Am_Region *region)
{
 ...
 */
void
Am_Drawonable_Impl::Push_Clip(int left, int top, unsigned int width,
                              unsigned int height)
{
 ...
 */
bool
Am_Drawonable_Impl::In_Clip(int x, int y)
{
 ...
 */
bool
Am_Drawonable_Impl::In_Clip(int left, int top, unsigned int width,
...
bool
Am_Drawonable_Impl::In_Clip(Am_Region *rgn, bool &total)
{
                               ...
                               int arg_height)
{
  ...
  Rect windRect;
  SetRect(&windRect, arg_left, arg_top, arg_left + arg_width,
          arg_top + arg_height);
  focus_on_this();
...
long GrowZoneCallBack(Size /* bytesNeeded */)
{
...
{
public:
  mac_init_object() { mac_initialize(); }
};
...
void
unlock_current_pixmap(PixMapHandle pixMapH)
{
