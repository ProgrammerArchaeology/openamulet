...
#ifndef OA_VERSION
AM_IMPL_MAP(Unmarshall_Methods, Am_Value_Type, Am_NONE, Am_Unmarshall_Method,
            Am_No_Unmarshall_Method)
AM_IMPL_MAP(Marshall_Methods, Am_Value_Type, Am_NONE, Am_Marshall_Method,
            Am_No_Marshall_Method)
...
long int
Am_Connection::Extract_Instance_Num(const char *id_str)
{
  long int inst_num;
  char proto_name[30];
...
void
Am_Connection::Register_Default_Methods(void)
{
...
bool
Am_Connection::Sockets_Have_Input(fd_set *fds)
{
  unsigned int index;
...
bool
Am_Connection::Register_Receiver(Am_Receive_Method &receiver)
{
...
void
Am_Connection::Close(void)
{
  close(data->m_socket);
}

int
Am_Connection::Get_Socket(void)
{
  return data->m_socket;
}

bool
Am_Connection::Connected(void)
{
...
void
Am_Connection::Set_Socket(int the_socket)
{
  if (the_socket >= 0)
...
void
Am_Connection::Set_Connect_Flag(bool state)
{
  if (data)
...
bool
Am_Connection::Waiting()
{
  return data->waiting;
}

void
Am_Connection::Set_Waiting_Flag(bool state)
{
  if (data)
    data->waiting = state;
  else
...
void
Am_Connection::Add_Connection(Am_Connection *new_connection)
{
...
void
Am_Connection::Delete_Connection(int sock)
{
...
void
Am_Connection::Delete_Connection(Am_Connection &doomed_connection_ref)
{
...
void
Am_Connection::Read_Length_and_List()
{
...
void
Am_Connection::Read_List(unsigned long int length)
{
...
void
Am_Connection::Add_To_Current_List(Am_Value val)
{
...
//
bool
Am_Connection::Register_Prototype(Am_String name, Am_Object &obj)
{
  Am_String old_name;
  Am_Object old_obj;
...
const char *
Am_Connection::Get_Net_Proto_Name(Am_Object &the_obj)
{
  Am_String name;
...
Am_Object
Am_Connection::Get_Net_Prototype(const char *proto_name)
{
  Am_Object obj;
...
const char *
Am_Connection::Get_Net_Object_ID(Am_Object &the_obj)
{
...
int
Am_Connection::Num_Instances(void)
{
...
void
Am_Connection::Receive_Object_Slots(void)
{
  data->my_receiver = receive_obj_slots;
}

void
Am_Connection::Add_To_Current_Object(Am_Value val)
{
