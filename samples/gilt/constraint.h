...
enum Which_Constraint_Handle_vals{
  NO_HANDLE_val, CH_TOP_val, CH_LEFT_val, CH_BOTTOM_val,
  CH_RIGHT_val, CH_HEIGHT_val, CH_WIDTH_val, CH_CENTER_X_val,
  CH_CENTER_Y_val, CH_X1_val, CH_X2_val, CH_Y1_val,
  CH_Y2_val, CH_SPECIAL_val
};
