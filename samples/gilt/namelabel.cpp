...
Am_Object
Name_And_Label_Window_Initialize(bool is_bitmap)
{
  ((is_bitmap) ? Name_And_Image_Window : Name_And_Label_Window) =
      Am_Window
          .Create((is_bitmap) ? "Name_And_Image_Window"
                              : "Name_And_Label_Window")
          .Set(Am_DESTROY_WINDOW_METHOD,
               Am_Default_Pop_Up_Window_Destroy_Method)
          .Set(Am_FILL_STYLE, Am_Motif_Light_Gray)
          .Set(Am_TITLE, (is_bitmap) ? "Name and Image Setting"
                                     : "Name and Label Setting")
          .Set(Am_ICON_TITLE,
               (is_bitmap) ? "Settings: Name and Image File for Bitmap Object"
          ...
          .Add_Part(LABEL_OBJ,
                    Am_Text_Input_Widget.Create("LABEL")
