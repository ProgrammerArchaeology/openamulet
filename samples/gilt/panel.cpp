...
void
change_selection(int rank, Am_String new_one, Am_bool do_set = true)
{
  int i;
  if (do_set) {
...

{
  ...
  if (new_one != selected_item)
    change_selection((int)new_one.Get(Am_RANK),
                     (Am_String)new_one.Get(Am_TEXT));
  else
    win.Set(MY_RANK, -1);
}
...
void
Set_Items_Group_Items(Am_Value_List &il)
{
  Am_Value_List new_l;
  Am_Value item;
  Am_Object o;
...
void
paneldialog::SetValues(Am_String &name, Am_Value_List &il, Am_Value &layout_key,
                       ...
                       Am_Value &vspace, Am_Value &maxrnk)
{
  ...
  if (box_on_left.Exists()) {
    ...
    box_on_left_cmd.Set(Am_ACTIVE, false);
  ...
  if (fw.Exists()) {
    ...
    fixed_width.Set(Am_ACTIVE, false);
...
//layout_key 1 = horiz, 0 = vert
void
paneldialog::GetValues(Am_String &name, Am_Value_List &il, Am_Value &layout_key,
                       Am_Value &box_on_left, Am_Value &fw, Am_Value &hspace,
                       Am_Value &vspace, Am_Value &maxrnk)
{
...
void
Set_Change_Change_Items(bool can_change_items)
{
...
Am_bool
paneldialog::Execute(Am_String &name, Am_Value_List &il, Am_Value &layout_key,
                     Am_Value &box_on_left, Am_Value &fw, Am_Value &hspace,
  ...
  if (!win) {
    ...
    win =
        Am_Window.Create()
            ...
            .Add_Part(vert_box =
                          Am_Checkbox_Panel.Create("vert_box")
                              .Set(Am_LEFT, 8)
                              .Set(Am_TOP, 288)
                              .Set(Am_WIDTH, 247)
                              .Set(Am_HEIGHT, 25)
                              ...
                              .Set(Am_ITEMS, Am_Value_List().Add(vert_cmd).Add(
                                                 box_on_left_cmd)))
            .Add_Part(
                fixed_width =
                    Am_Checkbox_Panel.Create("fixed_width")
                        .Set(Am_LEFT, 8)
                        .Set(Am_TOP, 307)
                        .Set(Am_WIDTH, 106)
                        .Set(Am_HEIGHT, 25)
            ...
            .Add_Part(delete_button = Am_Button.Create("delete_button")
                                          ...
                                          .Set(Am_FILL_STYLE, Am_Motif_Gray)
                                          .Get_Object(Am_COMMAND)
                                          .Set(Am_LABEL, "Delete Item")
                                          .Get_Owner())
            .Add_Part(new_button =
                          Am_Button.Create("new_button")
                              .Set(Am_LEFT, Am_Center_X_Is_Center_Of_Owner)
                              .Set(Am_TOP, 241)
                              .Set(Am_FONT, fontarray[0][1][0])
                              .Set(Am_FILL_STYLE, Am_Motif_Gray)
                              .Get_Object(Am_COMMAND)
                              .Set(Am_LABEL, "New Item")
                              .Get_Owner())
            .Add_Part(update_button =
                          Am_Button.Create("update_button")
                              ...
                              .Set(Am_FILL_STYLE, Am_Motif_Gray)
                              .Get_Object(Am_COMMAND)
                              .Set(Am_LABEL, "Update Item")
                              .Get_Owner())
            .Add_Part(item_name = Am_Text_Input_Widget
                                      .Create("item_name")
                                      //.Set(Lw_FORMAT,"")
                                      .Set(Am_LEFT, 8)
                                      .Set(Am_TOP, 211)
                                      ...
                                      .Get_Owner())
            .Add_Part(h_spacing =
                          Am_Number_Input_Widget.Create("H_SPACING")
                              .Set(Am_LEFT, 30)
                              .Set(Am_TOP, 331)
                              .Set(Am_WIDTH, 289)
                              .Set(Am_FILL_STYLE, Am_Motif_Light_Gray)
            ...
            .Add_Part(v_spacing =
                          Am_Number_Input_Widget.Create("V_SPACING")
                              .Set(Am_LEFT, 29)
                              .Set(Am_TOP, 362)
                              .Set(Am_WIDTH, 290)
                              .Set(Am_FILL_STYLE, Am_Motif_Light_Gray)
            ...
            .Add_Part(
                max_rank =
                    Am_Number_Input_Widget.Create("MAX_RANK")
                        .Set(Am_LEFT, 0)
                        .Set(Am_TOP, 393)
                        .Set(Am_WIDTH, 319)
                        .Set(Am_FILL_STYLE, Am_Motif_Light_Gray)
    ...
    item_list.Add_Part(items_group =
                           Am_Map.Create("items_group")
                               .Set(Am_LEFT, 0)
                               .Set(Am_TOP, 0)
                               .Set(Am_WIDTH, 400)
    ...
    delete_button.Set(Am_ACTIVE, false)
        .Get_Object(Am_COMMAND)
        .Set(Am_DO_METHOD, delete_button_pressed_cmd);
    update_button.Set(Am_ACTIVE, false)
        .Get_Object(Am_COMMAND)
        .Set(Am_DO_METHOD, update_button_pressed_cmd);
    ...
    cancel_button.Get_Object(Am_COMMAND)
        .Set(Am_DO_METHOD, cancel_button_pressed_cmd);
