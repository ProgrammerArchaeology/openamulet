...
Am_Object Border_Rect_Window_Initialize () {
  Border_Rect_Window = Am_Window.Create("MainWindow")
    ...
    .Add_Part(LOOKS_SELECTED_OBJ, Am_Checkbox_Panel.Create("LOOKS_SELECTED_OBJ")
      .Set(Am_LEFT, 19)
      .Set(Am_TOP, 42)
      .Set(Am_FILL_STYLE, Am_Motif_Light_Gray)
      .Set(Am_ITEMS, Am_Value_List()
