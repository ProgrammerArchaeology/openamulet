...
Am_Object
Example_Create(Am_Feature_Vector feat)
{
  Am_Object e = Example.Create().Set(EXAMPLE_FEATURES, feat);
  return e;
}

Am_Value_List
Example_Create_List(Am_Value_List feats)
{
...
Class_Init()
{
  ...
  Class =
      Am_Group
          ...
          .Add_Part(
              CLASS_LABEL,
              Am_Text.Create("Class_label").Set(Am_TEXT, same_as_class_name))
...
Am_Define_Method(Am_Object_Method, void, do_show_load_dialog,
                 (Am_Object /*cmd*/))
{
...
Am_Define_Method(Am_Object_Method, void, do_confirm, (Am_Object cmd))
{
  ...
  if (!confirm_dialog.Valid()) {
    confirm_dialog =
        Am_Window.Create("confirm_dialog")
            .Set(Am_LEFT, 100)
            .Set(Am_TOP, 100)
            ...
            .Add_Part(
                ...
                Am_Widget_Group.Create()
                    ...
                    .Add_Part(Am_Text.Create().Set(
                        Am_TEXT, "The classifier has changed."))
                    .Add_Part(Am_Text.Create().Set(Am_TEXT,
...
main(int argc, char *argv[])
{
          ...
          .Set(
              ...
              Am_Value_List()
                  .Add(Am_Command.Create("Amulet_Command")
                           ...
                           .Set(Am_ITEMS, Am_Value_List().Add("About Agate..."))
                           .Set(Am_ACTIVE, false))
                  .Add(
  ...
  ;
  Am_Object class_control =
      Am_Button_Panel.Create("class_control")
          .Set(Am_ITEMS, Am_Value_List()
  ...
  Am_Object example_control =
      Am_Button_Panel.Create("example_control")
          .Set(Am_ITEMS,
               Am_Value_List().Add(Am_Command.Create("delete_example")
  ...
  mode = Am_Radio_Button_Panel.Create("mode")
             .Set(Am_ITEMS,
                  Am_Value_List().Add(training_mode).Add(recognizing_mode))
             .Set(Am_LAYOUT, Am_Horizontal_Layout)
             .Set(Am_H_SPACING, 30)
             .Set(Am_VALUE, training_mode);
  mode.Get_Object(Am_COMMAND).Set(Am_DO_METHOD, do_change_mode);
  ...
  window.Add_Part(menu_bar).Add_Part(window_layout);
