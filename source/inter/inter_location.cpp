...
class Am_Inter_Location_Data : public Am_Wrapper
{
	...
	public:
		...
		Am_Inter_Location_Data(bool as_line, Am_Object ref_obj,	int a, int b, int c, int d, bool grow, bool direct);
...
Am_Inter_Location::Am_Inter_Location (const Am_Object& object)
{
  ...
  data = new Am_Inter_Location_Data (as_line, owner, a, b, c, d, true,
				     directional);
}
...
void Am_Inter_Location::Set_Location (bool as_line, Am_Object ref_obj,
  ...
  else data = new Am_Inter_Location_Data(as_line, ref_obj, a, b, c, d, true,
					 true);
}
...
void Am_Inter_Location::Set_Growing (bool growing,
				     bool make_unique) {
  if (data) {
    if (make_unique) data = (Am_Inter_Location_Data*)data->Make_Unique();
  }
...
bool Am_Inter_Location::Get_Growing () const {
  if (!data) Am_Error("Am_Inter_Location not initialized");
  return data->growing;
}

void Am_Inter_Location::Set_Directional (bool directional, bool make_unique)
{
  if (data) {
    if (make_unique) data = (Am_Inter_Location_Data*)data->Make_Unique();
  }
...
bool Am_Inter_Location::Get_Directional () const {
  if (!data) Am_Error("Am_Inter_Location not initialized");
  return data->directional;
}


void Am_Inter_Location::Set_Control (Am_Location_Value_Control a_control,
				     Am_Location_Value_Control b_control,
				     Am_Location_Value_Control c_control,
				     Am_Location_Value_Control d_control,
				     bool make_unique) {
...
void Am_Inter_Location::Set_Control (Am_Location_Value_Control all_control,
				     bool make_unique) {
  if (data) {
    if (make_unique) data = (Am_Inter_Location_Data*)data->Make_Unique();
  }
...
void Am_Inter_Location::Set_A_Control (Am_Location_Value_Control control,
				       bool make_unique) {
  if (data) {
    if (make_unique) data = (Am_Inter_Location_Data*)data->Make_Unique();
  }
...
void Am_Inter_Location::Set_B_Control (Am_Location_Value_Control control,
				       bool make_unique) {
  if (data) {
    if (make_unique) data = (Am_Inter_Location_Data*)data->Make_Unique();
  }
...
void Am_Inter_Location::Set_C_Control (Am_Location_Value_Control control,
				       bool make_unique)  {
  if (data) {
    if (make_unique) data = (Am_Inter_Location_Data*)data->Make_Unique();
  }
...
void Am_Inter_Location::Set_D_Control (Am_Location_Value_Control control,
					 bool make_unique) {
  if (data) {
    if (make_unique) data = (Am_Inter_Location_Data*)data->Make_Unique();
  }
...
void Am_Inter_Location::Get_Control (Am_Location_Value_Control &a_control,
				     Am_Location_Value_Control &b_control,
				     Am_Location_Value_Control &c_control,
...
void Am_Inter_Location::Install (Am_Object& object) const {
  if (!data) Am_Error("Am_Inter_Location not initialized");
...
void Am_Inter_Location::Install (Am_Object& object, bool growing) const {
  ...
  if (data->ref_obj.Valid () && owner != data->ref_obj) {
    Am_INTER_TRACE_PRINT(Am_INTER_TRACE_SETTING,
		      "Translating set coordinates from " << data->ref_obj <<
		      " to " << owner);
...
bool Am_Inter_Location::Is_Zero_Size () const {
  if (!data) Am_Error("Am_Inter_Location not initialized");
  if (data->as_line) {
    if (data->data.line.x1 == data->data.line.x2 &&
	data->data.line.y1 == data->data.line.y2) return true;
  }
  else {
    if (data->data.rect.width <= 0 || data->data.rect.height <= 0) return true;
  }
  return false;
}

std::ostream& operator<< (std::ostream& os, Am_Inter_Location& loc) {
  loc.Print(os);
  return os;
}
