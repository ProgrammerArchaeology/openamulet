...
Am_Slot_Key Am_SLOTS_TO_ITEMS = Am_Register_Slot_Name("~Am_SLOTS_TO_ITEMS~");
Am_Slot_Key Am_TYPE_USE_ITEM = Am_Register_Slot_Name("~Am_TYPE_USE_ITEM~");
...
enum Am_Which_Search_Direction
{
  Am_No_Search,
  Am_Search_Forward,
  Am_Search_Back,
...
void
internal_search_using(Am_Object &cmd, Am_Which_Search_Direction dir,
                      Am_Object &sel_widget, Am_Value_List &old_sel_list,
                      Am_Value_List &slots_and_values_used)
{
  ...
  if (found.Valid()) {
    ...
    cmd.Set(Am_SLOTS_AND_VALUES_USED, slots_and_values_used,
            Am_OK_IF_NOT_THERE);
...
Am_Define_Method(Am_Object_Method, void, done_search, (Am_Object cmd))
{
...
Am_Define_Method(Am_Object_Method, void, pop_up_search_window, (Am_Object cmd))
{
