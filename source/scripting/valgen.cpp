...
Am_Define_Method(Am_Text_Check_Legal_Method, Am_Text_Abort_Or_Stop_Code,
                 am_check_valid_type, (Am_Object & text, Am_Object &inter))
{
...
#endif
  if (!ok) {
    AM_POP_UP_ERROR_WINDOW("Sorry, could not parse `"
                           << str << "' as a "
...
Am_Define_Method(Am_Text_Check_Legal_Method, Am_Text_Abort_Or_Stop_Code,
                 am_check_valid_list_type, (Am_Object & text, Am_Object &inter))
{
  Am_String str = text.Get(Am_TEXT);
  Am_Object widget = inter.Get_Owner();
...
am_valgen_Initialize()
{
  am_valgen = Am_Window.Create(DSTR("am_genval"))
                  ...
                  .Add(Am_VALUE, (0L));
  am_valgen.Add_Part(Am_Border_Rectangle.Create()
                         .Set(Am_LEFT, 14)
                         .Set(Am_TOP, 112)
                         .Set(Am_WIDTH, 455)
                         .Set(Am_HEIGHT, 164)
  ...
  am_valgen.Add_Part(Am_Border_Rectangle.Create()
                         ...
                         .Set(Am_SELECTED, 0)
                         .Set(Am_FILL_STYLE, Am_Default_Color));
  am_valgen.Add_Part(Am_Text.Create()
                         .Set(Am_LEFT, 9)
                         .Set(Am_TOP, 9)
                         .Set(Am_WIDTH, 198)
                         .Set(Am_HEIGHT, 22)
      ...
      Am_Radio_Button_Panel.Create()
          ...
          .Set(
              ...
              Am_Value_List()
                  ...
                  .Add(Am_Command.Create()
                           .Set(Am_LABEL,
                                "The value of the palette when the script runs")
  ...
  am_valgen.Add_Part(
      ...
      Am_Text_Input_Widget.Create(DSTR("CONSTANT_OBJECTS_WIDGET"))
          ...
          .Set(Am_FILL_STYLE, Am_Default_Color));
  am_valgen.Add_Part(
      Am_NEXT_CONSTANT_OBJECTS_WIDGET,
  ...
  am_valgen.Add_Part(
      ...
      Am_Text_Input_Widget.Create(DSTR("ALL_FROM_COMMAND_WIDGET"))
          ...
          .Get_Owner()
          .Set(Am_FILL_STYLE, Am_Default_Color));
  am_valgen.Add_Part(Am_COMMAND_LOAD_BUTTON,
      ...
      Am_Button_Panel.Create(DSTR("OK-cancel"))
          ...
          .Set(Am_ITEMS, Am_Value_List()
                             .Add(Am_Standard_OK_Command.Create().Set(
                                 Am_DO_METHOD, am_valgen_ok))
                             .Add(Am_Standard_Cancel_Command.Create().Set(
                                 Am_DO_METHOD, am_valgen_cancel))));
  am_valgen.Add_Part(
      Am_GREEN_AND_YELLOW,
      Am_Radio_Button_Panel.Create(DSTR("GREEN_AND_YELLOW"))
          ...
          .Set(Am_ITEMS,
               Am_Value_List()
                   ...
                   .Add(Am_Command.Create()
                            .Set(Am_LABEL,
                                 "Generalize green and yellow selected values")
                            .Set(Am_ID, am_generalize_green_and_yellow)))
          .Set(Am_LAYOUT, Am_Vertical_Layout)
          .Set(Am_H_SPACING, 0)
          .Set(Am_V_SPACING, 0)
          .Set(Am_MAX_RANK, 0));
  am_valgen.Add_Part(Am_Tab_To_Next_Widget_Interactor.Create());
  return am_valgen;
}
