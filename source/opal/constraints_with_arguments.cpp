...
class Key_Store_Data : public Am_Wrapper {
 ...
 public:
  ...
  bool operator== (Key_Store_Data& test)
    { return key == test.key; }
  bool operator== (Key_Store_Data& test) const
    { return key == test.key; }
...
class Part_Key_Offset_Store_Data : public Am_Wrapper {
 ...
 public:
  ...
  Part_Key_Offset_Store_Data (Part_Key_Offset_Store_Data* proto)
    : part(proto->part), key(proto->key),
      offset(proto->offset), multiplier(proto->multiplier)
    { }
...
static Am_Value bottom_of_sibling_procedure (Am_Object& self)
{
  Am_Value value;
  Part_Key_Offset_Store_Data* store = (Part_Key_Offset_Store_Data*)
       Am_Object_Advanced::Get_Context ()->Get_Data  ();
...
Am_Formula Am_Bottom_Of_Sibling (Am_Slot_Key sibling, int offset,
				 float multiplier)
{
  Am_Formula formula (bottom_of_sibling_procedure, DSTR("Am_Bottom_Of_Sibling"));
  formula.Set_Data (new Part_Key_Offset_Store_Data (sibling, 0, offset,
						    multiplier));
  return formula;
}

static Am_Value right_of_sibling_procedure (Am_Object& self)
{
  Am_Value value;
  Part_Key_Offset_Store_Data* store = (Part_Key_Offset_Store_Data*)
       Am_Object_Advanced::Get_Context ()->Get_Data  ();
...
Am_Formula Am_Right_Of_Sibling (Am_Slot_Key sibling, int offset,
				 float multiplier)
{
...
static Am_Value rest_of_height_above_procedure (Am_Object& self)
{
  Am_Value value;
  Part_Key_Offset_Store_Data* store = (Part_Key_Offset_Store_Data*)
       Am_Object_Advanced::Get_Context ()->Get_Data  ();
...
Am_Formula Am_Rest_Of_Height_Above (Am_Slot_Key sibling, int offset)
{
...
class Object_Key_Offset_Store_Data : public Am_Wrapper {
 ...
 public:
  Object_Key_Offset_Store_Data (Am_Object in_object, Am_Slot_Key in_key,
				int in_offset, float in_multiplier)
    : object(in_object), key(in_key), offset(in_offset), multiplier(in_multiplier)
    { }
