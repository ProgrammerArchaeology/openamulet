...
Am_Define_Method(Am_Object_Method, void, button_panel_abort_method,
                 (Am_Object widget))
{
  Am_Object inter = widget.Get_Object(Am_INTERACTOR);
...
init()
{
  ...
  Am_Button_Panel =
      Am_Widget_Map.Create(DSTR("Button Panel"))
          .Add(Am_VALUE, (0L))
          .Add(Am_OLD_VALUE, 0)
          ...
          .Add(Am_LEAVE_ROOM_FOR_FRINGE,
               false) // normally no fringe in button panels
          ...
          .Add_Part(
              Am_INTERACTOR,
              inter = Am_Choice_Interactor_Repeat_Same
                          .Create(DSTR("inter_in_button_panel"))
                          ...
                          .Set(Am_VALUE,
                               inter_value_from_panel_value.Multi_Constraint()))
          .Set_Part(
              Am_ITEM_PROTOTYPE,
              Am_Button_In_Panel =
                  Am_Button.Create(DSTR("Button_In_Panel_Proto"))
                      ...
                      .Set(Am_LEAVE_ROOM_FOR_FRINGE,
                           Am_From_Owner(Am_LEAVE_ROOM_FOR_FRINGE))
          ...
          .Add_Part(Am_COMMAND,
                    Am_Command.Create(DSTR("Command_In_Button_Panel"))
...
static Am_Initializer *initializer =
    new Am_Initializer(DSTR("Am_Button_Panel"), init, 5.204f, 106, cleanup);
