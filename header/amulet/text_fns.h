...
Am_Insert_String_At_Cursor(Am_Object text, const char *str,
                           bool advance_cursor = true);
...
_OA_DL_IMPORT extern void
Am_Obj_Or_Feedback_Cursor_On_Off(Am_Object obj_over, Am_Object feedback_obj,
                                 bool turn_on_p, Am_Object inter);

//turn pending delete on or off
_OA_DL_IMPORT extern void Am_Set_Pending_Delete(Am_Object text,
                                                bool pending_delete);
