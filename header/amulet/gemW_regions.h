...
public:
  Am_WinRect() { SetEmpty(); };
  Am_WinRect(int the_left, int the_top, unsigned int the_width,
...
public:
  void Set(int the_left, int the_top, unsigned int the_width,
           unsigned int the_height)
  {
    ::SetRect(this, the_left, the_top, the_left + the_width,
              the_top + the_height);
  };
  ...
  {
    Am_WinRect rc;
    ::UnionRect(&rc, this, &wrect);
    return rc;
  };
  Am_WinRect operator*(const Am_WinRect &wrect) const
  {
    Am_WinRect rc;
    ::IntersectRect(&rc, this, &wrect);
    return rc;
  };
...
public:
  Am_WinRegion();
  Am_WinRegion(int the_left, int the_top, unsigned int the_width,
               unsigned int the_height);
...
public:
  ...
  virtual void Set(int the_left, int the_top, unsigned int the_width,
                   unsigned int the_height);

  void Push(const Am_WinRect &wrect);
  virtual void Push(/*const*/ Am_Region *the_region);
  virtual void Push(int the_left, int the_top, unsigned int the_width,
                    unsigned int the_height);
  virtual void Pop();
  ...
  virtual void Union(int the_left, int the_top, unsigned int the_width,
                     unsigned int the_height);

  void Intersect(const Am_WinRect &wrect);
  virtual void Intersect(const Am_Region *the_region); // not in Am_Region
  virtual void Intersect(int the_left, int the_top, unsigned int the_width,
                         unsigned int the_height);

  virtual bool In(int x, int y); // const;
  virtual bool In(int x, int y, unsigned int width, unsigned int height,
                  bool &total);                           // const;
...
protected:
  operator const Am_WinRect &() const { return m_rect; };
protected:
  HRGN m_hrgn;
  Am_WinRect m_rect;
