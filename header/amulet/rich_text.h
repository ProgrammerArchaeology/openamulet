...
public:
  ...
  inline void Draw_Line( Am_Drawonable* inDrawonable,
                         long inLeft,
                         long inTop,
  ...
  inline Am_Text_Fragment*
             Get_Fragment_At( const Am_Text_Index inIndex,
...
public:
  ...
  Am_Rich_Text_Data(
    const char* inString,
    Am_Font     inFont      = Am_Default_Font,
  ...
  Am_Text_Fragment*  Get_Fragment_At(
  ...
  Am_Text_Style_Run* Get_Style_Run_At(
    const Am_Text_Index inIndex,
...
public:
  ...
  // is called.
  void Draw( Am_Drawonable* inDrawonable,
             long inLeft,
             long inTop );
};
...
public:
  ...
  void Init( Am_Rich_Text  inText,
             unsigned long inWidth );

  void Layout( Am_Drawonable* inDrawonable,
               Am_Text_Index  inFirstInvChar = 0,
  ...
  void Invalidate_Text_Range( Am_Text_Index   inStart,
...
{
public:
  Am_Text_Fragment( Am_Rich_Text_Data* inTextObject,
                    const char*        inString );
  Am_Text_Fragment( Am_Rich_Text_Data* inTextObject,
                    const char*        inString,
...
{
public:
  Am_Text_Style_Run( unsigned long inCharsInRun,
                     Am_Font       inFont,
