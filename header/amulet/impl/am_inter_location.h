...
enum Am_Location_Value_Control
{
  Am_LOCATION_OK,
  Am_LOCATION_RELATIVE,
...
public:
  ...
  Am_Inter_Location(bool as_line, Am_Object ref_obj, int a, int b, int c, int d,
                    bool growing = true, bool directional = true);
