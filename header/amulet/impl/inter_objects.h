...
_OA_DL_IMPORT extern Am_Object
    Am_Choice_Interactor; // choosing one or more from a set
_OA_DL_IMPORT extern Am_Object
    Am_One_Shot_Interactor; // goes immediately at input event
_OA_DL_IMPORT extern Am_Object
    Am_Move_Grow_Interactor; // moving and growing with mouse
_OA_DL_IMPORT extern Am_Object
    Am_New_Points_Interactor; // entering new points with mouse
