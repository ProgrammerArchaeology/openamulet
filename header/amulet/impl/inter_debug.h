...
_OA_DL_IMPORT void
Am_Set_Inter_Trace(Am_Inter_Trace_Options trace_code); //add trace of that
_OA_DL_IMPORT void
Am_Set_Inter_Trace(Am_Object inter_to_trace); //add trace of that inter
_OA_DL_IMPORT void
Am_Clear_Inter_Trace(); //set not trace, same as Am_Set_Inter_Trace(0)
