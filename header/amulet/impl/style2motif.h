...
inline int
HashValue(Am_Wrapper *key, int size)
{
  return HashValue((const void *)key, size);
}

inline int
KeyComp(Am_Wrapper *key1, Am_Wrapper *key2)
{
...
#else
typedef OpenAmulet::Map<Am_Wrapper *, Computed_Colors_Record_Data *>
    Am_Map_Style2MotifRec;
typedef OpenAmulet::Map_Iterator<Am_Map_Style2MotifRec>
    Am_Map_Iterator_Style2MotifRec;
