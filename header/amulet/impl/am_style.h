...
public:
  ...
  Am_Style(float r, float g, float b, //color part
           short thickness = 0, Am_Line_Cap_Style_Flag cap = Am_CAP_BUTT,
  ...
  Am_Style(const char *color_name, short thickness = 0,
  ...
  _OA_DL_MEMBERIMPORT void
  Get_Values(short &thickness, Am_Line_Cap_Style_Flag &cap,
  ...
  _OA_DL_MEMBERIMPORT void
  Get_Values(float &r, float &g, float &b, short &thickness,
  ...
  _OA_DL_MEMBERIMPORT void
  Get_Line_Thickness_Values(short &thickness,
