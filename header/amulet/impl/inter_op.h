...
_OA_DL_IMPORT extern void Am_Abort_Interactor(Am_Object inter,
...
Am_Stop_Interactor(Am_Object inter, Am_Object stop_obj = Am_No_Object,
...
_OA_DL_IMPORT extern void
Am_Start_Interactor(Am_Object inter, Am_Object start_obj = Am_No_Object,
...
_OA_DL_IMPORT extern void Am_Choice_Set_Value(Am_Object inter,
                                              bool set_selected);
...
_OA_DL_IMPORT extern bool Am_Check_Inter_Abort_Inactive_Object(
    Am_Object &object, Am_Slot_Key slot_for_inactive, Am_Object &inter);
...
_OA_DL_IMPORT bool
Am_Valid_and_Visible_List_Or_Object(Am_Value value, bool want_visible = true);

// Applies the gridding, if any, defined by the inter's GRID slots
_OA_DL_IMPORT extern void Am_Get_Filtered_Input(Am_Object inter,
                                                const Am_Object &ref_obj, int x,
                                                int y, int &out_x, int &out_y);

// sets the left,top,width,height or x1,y1,x2,y2 of obj from data
_OA_DL_IMPORT extern void Am_Modify_Object_Pos(Am_Object &obj,
                                               const Am_Inter_Location &data,
                                               bool growing);
...
_OA_DL_IMPORT extern bool Am_Inter_Call_Both_Method(
    Am_Object &inter, Am_Object &command_obj, Am_Slot_Key method_slot, int x,
    int y, Am_Object &ref_obj, Am_Input_Char &ic, Am_Object &object_modified,
