...
enum Am_Fill_Poly_Flag
{
  Am_FILL_POLY_EVEN_ODD = 0,
  Am_FILL_POLY_WINDING = 1
};

enum Am_Line_Cap_Style_Flag
{
  Am_CAP_NOT_LAST = 0,
  Am_CAP_BUTT = 1,
  Am_CAP_ROUND = 2,
...
enum Am_Line_Solid_Flag
{
  Am_LINE_SOLID = 0,
  Am_LINE_ON_OFF_DASH = 1
};

#define Am_DEFAULT_DASH_LIST_VALUE                                             \
  {                                                                            \
    4, 4                                                                       \
  }
...
enum Am_Font_Family_Flag
{
  Am_FONT_FIXED,
  Am_FONT_SERIF,
  Am_FONT_SANS_SERIF,    // Standard fonts for one-byte code
...
enum Am_Font_Size_Flag
{
  Am_FONT_SMALL = 0,
  Am_FONT_MEDIUM = 1,
  Am_FONT_LARGE = 2,
  Am_FONT_VERY_LARGE = 3,
  // the constant definitions for the sizes of Two-byte code are below
  Am_FONT_TSMALL = 0x10,
  Am_FONT_TMEDIUM = 0x11,
  Am_FONT_TLARGE = 0x12,
  Am_FONT_TVERY_LARGE = 0x13
};
