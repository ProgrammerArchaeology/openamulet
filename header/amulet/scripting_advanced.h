...
_OA_SCRIPT_DL_IMPORT extern Am_Object
...
_OA_SCRIPT_DL_IMPORT extern bool am_find_cmd_in_sel(Am_Value_List &sel_list,
                                                    Am_Object &target_cmd,
                                                    Am_Object &found_sel);

_OA_SCRIPT_DL_IMPORT extern void am_write_command_name(Am_Object cmd, int cnt,
                                                       OSTRSTREAM &oss);
...
_OA_SCRIPT_DL_IMPORT extern Am_Object
    Am_A_Placeholder; //prototype for all the placeholders
_OA_SCRIPT_DL_IMPORT extern Am_Object
    Am_Constant_Placeholder; //placeholder for constant values
...
_OA_SCRIPT_DL_IMPORT extern Am_Object Am_Script_Line_Group,
    Am_Script_Line_Command, Am_Script_Line_Selectable, Am_Script_Line_Modified,
    Am_Script_Line_Value;

//procedures in generalizers.cc
_OA_SCRIPT_DL_IMPORT extern bool Am_Handle_Placeholders_And_Call_Command(
...
_OA_SCRIPT_DL_IMPORT extern void
am_check_obj_modified(Am_Object &in_cmd, Am_Value_List &place_holder_list,
...
AM_DEFINE_METHOD_TYPE(Am_Placeholder_Replace_Method, bool,
                      ...
                      AM_DEFINE_METHOD_TYPE(Am_Placeholder_Set_Value_Method,
                                            bool,
...
public:
  ...
  int width_equals, width_offset, width_object_offset, width_object_percent;
  int height_equals, height_offset, height_object_offset, height_object_percent,
...
_OA_SCRIPT_DL_IMPORT extern bool am_get_placeholder_from(Am_Value &current_val,
                                                         Am_Object &ph);

// searching window

_OA_SCRIPT_DL_IMPORT extern bool am_find_proto_and_name(Am_Object &target_obj,
                                                        Am_Assoc &answer);
