...
public:
  ...
  bool operator== (Am_Feature_Vector_Data&) const
  { return false; }
...
public:
  ...
  { return false; }
  bool operator== (Am_Gesture_Classifier_Data&) const
  { return false; }
...
protected:
  struct Gesture_Class {
    ...
    Gesture_Class ()  { average = (0L); w = NULL; }
    ~Gesture_Class () { if (average) {FreeVector(average); average = (0L);}
	        if (w) {FreeVector(w); w = (0L);} }
  };
...
public:
  ...
  { return false; }
  bool operator== (Am_Gesture_Trainer_Data&) const
  { return false; }
  ...
  struct Gesture_Class {
    ...
    Gesture_Class (Gesture_Class *d) 
      { name = d->name; examples = d->examples; }
  };
