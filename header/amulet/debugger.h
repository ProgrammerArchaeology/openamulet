...
_OA_DL_IMPORT extern bool Am_Parse_Input_As_Type(Am_String input,
...
_OA_DL_IMPORT extern void Am_Inspect(const Am_Object &object,
                                     Am_Slot_Key slot = Am_NO_SLOT);

// inspect the specific object and go into a main_loop
_OA_DL_IMPORT extern void
Am_Inspect_And_Main_Loop(const Am_Object &object,
                         Am_Slot_Key slot = Am_NO_SLOT);
...
_OA_DL_IMPORT extern void Am_Flash(Am_Object o,
                                   std::ostream &flashout = std::cout);
...
_OA_DL_IMPORT void Am_Notify_On_Slot_Set(Am_Object object = Am_No_Object,
                                         Am_Slot_Key key = 0,
                                         Am_Value value = Am_No_Value);
_OA_DL_IMPORT void Am_Break_On_Slot_Set(Am_Object object = Am_No_Object,
                                        Am_Slot_Key key = 0,
                                        Am_Value value = Am_No_Value);
_OA_DL_IMPORT void Am_Clear_Slot_Notify(Am_Object object = Am_No_Object,
                                        Am_Slot_Key key = 0,
                                        Am_Value value = Am_No_Value);
_OA_DL_IMPORT void
Am_Start_Slot_Value_Tracing(Am_Object object, Am_Slot_Key key,
                            Am_Object old_values_object = Am_No_Object);
_OA_DL_IMPORT void Am_Stop_Slot_Value_Tracing(Am_Object object,
                                              Am_Slot_Key key);

_OA_DL_IMPORT Am_Trace_Status Am_Update_Tracer_String_Object(
    Am_Object obj, Am_Slot_Key key, Am_Object string_obj);
_OA_DL_IMPORT void Am_Invalidate_All_Tracer_String_Objects(Am_Object the_obj);
_OA_DL_IMPORT Am_Value_List Am_Get_Tracer_Old_Values(Am_Object obj,
                                                     Am_Slot_Key key,
                                                     Am_Object object);
_OA_DL_IMPORT Am_Trace_Status Am_Get_Tracer_Status(Am_Object obj,
                                                   Am_Slot_Key key);

_OA_DL_IMPORT void Am_Add_Old_Values(Am_Value_List old_values,
                                     Am_Object value_string,
