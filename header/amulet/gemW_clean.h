...
public:
  void In(void *item, Am_WinCleanFunc func) { m_map.SetAt(item, func); }
  void Out(void *item) { m_map.DeleteKey(item); }
...
private:                                                                       \
  BOOL m_fUsedRes;                                                             \
  void WinSetUsedRes() { m_fUsedRes = TRUE; };                                 \
...
#define Am_WINCLEAN_CONSTR(C)                                                  \
  {                                                                            \
    WinCheckUsedRes();                                                         \
    g_cleaner->In(this, Am_WINCLEAN_FUNC(C));                                  \
  }
#define Am_WINCLEAN_DESTR                                                      \
  {                                                                            \
    g_cleaner->Out(this);                                                      \
