...
Am_Object Ktable_Init (Am_Font kline_font, char * ktitle, char * etitle, char * table_name)
{
  ...
  Am_Object Etitle = Am_Text.Create("Etitle")
      ...
      .Set (Am_LEFT, (int)Ktitle.Get(Am_LEFT) + (int)Ktitle.Get(Am_WIDTH) + 10)
      .Set (Am_TEXT, etitle);
  Ktable_Group.Add_Part(Etitle);

  Am_Object table = Am_Scrolling_Group.Create("table")
    .Set (Am_TOP, (int)Ktitle.Get(Am_TOP) + (int)Ktitle.Get(Am_HEIGHT) + 10)
  ...
  Am_Object line = Am_Text.Create("Kline")
    .Set(Am_LEFT, KLINE_LEFT)
    .Set(Am_FONT, kline_font);
...
Am_Object Edit_Init(char *title, char *ptext_string)
{
  ...
  Am_Object english = Am_Text.Create("english")
...
void Families_Init()
{
  ...
  Am_Object Jtext = Am_Text.Create("J text")
    .Set(Am_TEXT, J_TEST_STRING)
    .Set(Am_FONT, JTL_Font)
    .Set(Am_TOP, (int)kanji.Get(Am_TOP) + (int)kanji.Get(Am_HEIGHT) + 10);
  Families_Group.Add_Part(Jtext);

  Am_Object JPtext = Am_Text.Create("JP text")
  ...
  Am_Object Ctext = Am_Text.Create("C text")
    ...
    .Set(Am_LEFT, (int)Jtext.Get(Am_LEFT))
    .Set(Am_TOP, (int)JPtext.Get(Am_TOP) + (int)JPtext.Get(Am_HEIGHT) + 4);
  Families_Group.Add_Part(Ctext);

  Am_Object Ktext = Am_Text.Create("K text")
...
#ifdef _WIN32
  Am_Object MSMtext = Am_Text.Create("MSM text")
  ...
  Am_Object MSGtext = Am_Text.Create("MSG text")
      ...
      .Set(Am_LEFT, (int)Jtext.Get(Am_LEFT))
      .Set(Am_TOP, (int)MSMtext.Get(Am_TOP) + (int)MSMtext.Get(Am_HEIGHT) + 4);
  ...
  Am_Object MSMPtext = Am_Text.Create("MSMP text")
      ...
      .Set(Am_LEFT, (int)Jtext.Get(Am_LEFT))
      .Set(Am_TOP, (int)MSGtext.Get(Am_TOP) + (int)MSGtext.Get(Am_HEIGHT) + 4);
  ...
  Am_Object MSGPtext = Am_Text.Create("MSGP text")
      ...
      .Set(Am_LEFT, (int)Jtext.Get(Am_LEFT))
      .Set(Am_TOP, (int)MSMPtext.Get(Am_TOP) + (int)MSMPtext.Get(Am_HEIGHT) + 4);
  Families_Group.Add_Part(MSGPtext);
#endif
}

void More_Sizes_Init()
{
  ...
  Am_Object JStext = Am_Text.Create("JS text")
  ...
  Am_Object JVLtext = Am_Text.Create("JVL text")
      ...
      .Set(Am_TOP, (int)JTLtext.Get(Am_TOP) + (int)JTLtext.Get(Am_HEIGHT) + 4);
  ...
  Am_Object JTVLtext = Am_Text.Create("JTVL text")
      ...
      .Set(Am_TOP, (int)JVLtext.Get(Am_TOP) + (int)JVLtext.Get(Am_HEIGHT) + 4);
...
Am_Object Size_Face_Init(char * kanji_text, char * test_string, char * group_name)
{
  ...
  Am_Object english = Am_Text.Create("english1")
    .Set (Am_TOP, (int)kanji.Get(Am_TOP))
    .Set (Am_LEFT, (int)kanji.Get(Am_LEFT) + (int)kanji.Get(Am_WIDTH) + 10)
    .Set (Am_TEXT, "Japanese Font Test: style(b, i, u, l) x size(ts, tm, tl, tvl)");
  ...
  Am_Object JMtext = Am_Text.Create("JM text")
    .Set(Am_TEXT, test_string)
    .Set(Am_FONT, JTM_Font)
    .Set(Am_LEFT, (int)JbiuStext.Get(Am_LEFT) + (int)JbiuStext.Get(Am_WIDTH) + 10)
    .Set(Am_TOP, (int)kanji.Get(Am_TOP) + (int)kanji.Get(Am_HEIGHT) + 10);
  ...
  Am_Object JbMtext = Am_Text.Create("JbM text")
    ...
    .Set(Am_TOP, (int)JMtext.Get(Am_TOP) + (int)JMtext.Get(Am_HEIGHT) + 2);
  ...
  Am_Object JiMtext = Am_Text.Create("JiM text")
    ...
    .Set(Am_LEFT, (int)JMtext.Get(Am_LEFT))
    .Set(Am_TOP, (int)JbMtext.Get(Am_TOP) + (int)JbMtext.Get(Am_HEIGHT) + 2);
  ...
  Am_Object JbiMtext = Am_Text.Create("JbiM text")
    ...
    .Set(Am_LEFT, (int)JMtext.Get(Am_LEFT))
    .Set(Am_TOP, (int)JiMtext.Get(Am_TOP) + (int)JiMtext.Get(Am_HEIGHT) + 2);
  ...
  Am_Object JuMtext = Am_Text.Create("JuM text")
    ...
    .Set(Am_LEFT, (int)JMtext.Get(Am_LEFT))
    .Set(Am_TOP, (int)JbiMtext.Get(Am_TOP) + (int)JbiMtext.Get(Am_HEIGHT) + 2);
  ...
  Am_Object JbuMtext = Am_Text.Create("JbuM text")
    ...
    .Set(Am_LEFT, (int)JMtext.Get(Am_LEFT))
    .Set(Am_TOP, (int)JuMtext.Get(Am_TOP) + (int)JuMtext.Get(Am_HEIGHT) + 2);
  ...
  Am_Object JiuMtext = Am_Text.Create("JiuM text")
    ...
    .Set(Am_LEFT, (int)JMtext.Get(Am_LEFT))
    .Set(Am_TOP, (int)JbuMtext.Get(Am_TOP) + (int)JbuMtext.Get(Am_HEIGHT) + 2);
  ...
  Am_Object JbiuMtext = Am_Text.Create("JbiuM text")
    ...
    .Set(Am_LEFT, (int)JMtext.Get(Am_LEFT))
    .Set(Am_TOP, (int)JiuMtext.Get(Am_TOP) + (int)JiuMtext.Get(Am_HEIGHT) + 2);
  ...
  Am_Object JLtext = Am_Text.Create("JL text")
    .Set(Am_TEXT, test_string)
    .Set(Am_FONT, JTL_Font)
    .Set(Am_LEFT, (int)JbiuMtext.Get(Am_LEFT) + (int)JbiuMtext.Get(Am_WIDTH) + 10)
    .Set(Am_TOP, (int)kanji.Get(Am_TOP) + (int)kanji.Get(Am_HEIGHT) + 10);
  ...
  Am_Object JbLtext = Am_Text.Create("JbL text")
    ...
    .Set(Am_TOP, (int)JLtext.Get(Am_TOP) + (int)JLtext.Get(Am_HEIGHT) + 2);
  ...
  Am_Object JiLtext = Am_Text.Create("JiL text")
    ...
    .Set(Am_LEFT, (int)JLtext.Get(Am_LEFT))
    .Set(Am_TOP, (int)JbLtext.Get(Am_TOP) + (int)JbLtext.Get(Am_HEIGHT) + 2);
  ...
  Am_Object JbiLtext = Am_Text.Create("JbiL text")
    ...
    .Set(Am_LEFT, (int)JLtext.Get(Am_LEFT))
    .Set(Am_TOP, (int)JiLtext.Get(Am_TOP) + (int)JiLtext.Get(Am_HEIGHT) + 2);
  ...
  Am_Object JuLtext = Am_Text.Create("JuL text")
    ...
    .Set(Am_LEFT, (int)JLtext.Get(Am_LEFT))
    .Set(Am_TOP, (int)JbiLtext.Get(Am_TOP) + (int)JbiLtext.Get(Am_HEIGHT) + 2);
  ...
  Am_Object JbuLtext = Am_Text.Create("JbuL text")
    ...
    .Set(Am_LEFT, (int)JLtext.Get(Am_LEFT))
    .Set(Am_TOP, (int)JuLtext.Get(Am_TOP) + (int)JuLtext.Get(Am_HEIGHT) + 2);
  ...
  Am_Object JiuLtext = Am_Text.Create("JiuL text")
    ...
    .Set(Am_LEFT, (int)JLtext.Get(Am_LEFT))
    .Set(Am_TOP, (int)JbuLtext.Get(Am_TOP) + (int)JbuLtext.Get(Am_HEIGHT) + 2);
  ...
  Am_Object JbiuLtext = Am_Text.Create("JbiuL text")
    ...
    .Set(Am_LEFT, (int)JLtext.Get(Am_LEFT))
    .Set(Am_TOP, (int)JiuLtext.Get(Am_TOP) + (int)JiuLtext.Get(Am_HEIGHT) + 2);
  ...
  Am_Object JVLtext = Am_Text.Create("JVL text")
    ...
    .Set(Am_TOP, (int)JbiuLtext.Get(Am_TOP) + (int)JbiuLtext.Get(Am_HEIGHT) + 20);
  ...
  Am_Object JbVLtext = Am_Text.Create("JbVL text")
    ...
    .Set(Am_TOP, (int)JVLtext.Get(Am_TOP) + (int)JVLtext.Get(Am_HEIGHT) + 2);
  ...
  Am_Object JiVLtext = Am_Text.Create("JiVL text")
    ...
    .Set(Am_LEFT, (int)JVLtext.Get(Am_LEFT))
    .Set(Am_TOP, (int)JbVLtext.Get(Am_TOP) + (int)JbVLtext.Get(Am_HEIGHT) + 2);
  ...
  Am_Object JbiVLtext = Am_Text.Create("JbiVL text")
    ...
    .Set(Am_LEFT, (int)JVLtext.Get(Am_LEFT))
    .Set(Am_TOP, (int)JiVLtext.Get(Am_TOP) + (int)JiVLtext.Get(Am_HEIGHT) + 2);
  ...
  Am_Object JuVLtext = Am_Text.Create("JuVL text")
    ...
    .Set(Am_LEFT, (int)JVLtext.Get(Am_LEFT))
    .Set(Am_TOP, (int)JbiVLtext.Get(Am_TOP) + (int)JbiVLtext.Get(Am_HEIGHT) + 2);
  ...
  Am_Object JbuVLtext = Am_Text.Create("JbuVL text")
    ...
    .Set(Am_LEFT, (int)JVLtext.Get(Am_LEFT))
    .Set(Am_TOP, (int)JuVLtext.Get(Am_TOP) + (int)JuVLtext.Get(Am_HEIGHT) + 2);
  ...
  Am_Object JiuVLtext = Am_Text.Create("JiuVL text")
    ...
    .Set(Am_LEFT, (int)JVLtext.Get(Am_LEFT))
    .Set(Am_TOP, (int)JbuVLtext.Get(Am_TOP) + (int)JbuVLtext.Get(Am_HEIGHT) + 2);
  Size_Face_Group.Add_Part(JiuVLtext);

  Am_Object JbiuVLtext = Am_Text.Create("JbiuVL text")
    .Set(Am_TEXT, test_string)
    .Set(Am_FONT, JbiuTVL_Font)
    .Set(Am_LEFT, (int)JVLtext.Get(Am_LEFT))
    .Set(Am_TOP, (int)JiuVLtext.Get(Am_TOP) + (int)JiuVLtext.Get(Am_HEIGHT) + 2);
...
int  main ()
{
  ...
  Am_Object instructions1 = Am_Text.Create("instructions1")
      .Set (Am_TOP, (int)title.Get(Am_TOP))
      .Set (Am_LEFT, (int)title.Get(Am_LEFT) + (int)title.Get(Am_WIDTH) + 10)
      .Set (Am_TEXT, "1 for Size Face, 2 for More Sizes, 3 for Families, 4 for Edit");
  mywin.Add_Part(instructions1);

  Am_Object instructions2 = Am_Text.Create("instructions2")
      .Set (Am_TOP, (int)title.Get(Am_TOP) + (int)title.Get(Am_HEIGHT) + 2)
      .Set (Am_LEFT, (int)instructions1.Get(Am_LEFT))
      .Set (Am_TEXT, "5 for Size Face (EUC), 6 for Edit (EUC), 7 for Ktable, 8 for Kktable");
  mywin.Add_Part(instructions2);

  Am_Object instructions3 = Am_Text.Create("instructions2")
      .Set (Am_TOP, (int)instructions2.Get(Am_TOP) + (int)instructions2.Get(Am_HEIGHT) + 2)
      .Set (Am_LEFT, (int)instructions1.Get(Am_LEFT))
  ...
  qbutton.Set(Am_LEFT, (int)mywin.Get(Am_WIDTH) - (int)qbutton.Get(Am_WIDTH) - 10);
  ...
  Size_Face_EUC_Group = Size_Face_Init(EUC_KANJI, EUC_TEST_STRING, "Size Face EUC");
  ...
  Ktable_Group = Ktable_Init(KLINE_FONT, KTITLE, "Japanese Kanji Code Table", "Ktable");
  cout << "Initializing Kktable Group\n" << flush;
  Kktable_Group = Ktable_Init(KKLINE_FONT, KKTITLE, "Korean Code Table", "Kktable");
  cout << "Initializing Kctable Group\n" << flush;
  Kctable_Group = Ktable_Init(KCLINE_FONT, KCTITLE, "Chinese Code Table", "Kctable");
