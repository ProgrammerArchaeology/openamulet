...
Am_Define_Method(Am_Object_Method, void, change_setting, (Am_Object self))
{
  ...
  if (c == "q") {
    ...
    case Am_LEFT_ALIGN_val: layout1.Set (Am_H_ALIGN, Am_RIGHT_ALIGN); break;
    case Am_RIGHT_ALIGN_val: layout1.Set (Am_H_ALIGN, Am_CENTER_ALIGN); break;
    default: layout1.Set (Am_H_ALIGN, Am_LEFT_ALIGN); break;
    }
    h_align = layout2.Get (Am_H_ALIGN);
    switch (h_align.value) {
    case Am_LEFT_ALIGN_val: layout2.Set (Am_H_ALIGN, Am_RIGHT_ALIGN); break;
    case Am_RIGHT_ALIGN_val: layout2.Set (Am_H_ALIGN, Am_CENTER_ALIGN); break;
    default: layout2.Set (Am_H_ALIGN, Am_LEFT_ALIGN); break;
    }
  }
  else if (c == "b") {
    Am_Alignment v_align = layout1.Get (Am_V_ALIGN);
    switch (v_align.value) {
    case Am_TOP_ALIGN_val: layout1.Set (Am_V_ALIGN, Am_BOTTOM_ALIGN); break;
    case Am_BOTTOM_ALIGN_val: layout1.Set (Am_V_ALIGN, Am_CENTER_ALIGN); break;
    default: layout1.Set (Am_V_ALIGN, Am_TOP_ALIGN); break;
    }
    v_align = layout2.Get (Am_V_ALIGN);
    switch (v_align.value) {
    case Am_TOP_ALIGN_val: layout2.Set (Am_V_ALIGN, Am_BOTTOM_ALIGN); break;
    case Am_BOTTOM_ALIGN_val: layout2.Set (Am_V_ALIGN, Am_CENTER_ALIGN); break;
    default: layout2.Set (Am_V_ALIGN, Am_TOP_ALIGN); break;
    }
  }
  else if (c == "i") {
...
Am_Define_Style_Formula (map_fill)
{
  int rank = self.Get (Am_RANK);
  switch (rank) {
  case 0: return Am_Red;
  case 1: return Am_Blue;
  case 2: return Am_Green;
  case 3: return Am_Orange;
  case 4: return Am_Purple;
  case 5: return Am_Cyan;
  case 6: return Am_Yellow;
  default: return Am_White;
  }
}

Am_Define_Style_Formula (list_map_fill)
{
  return self.Get (Am_ITEM);
}
    ...
    .Add_Part (window = Am_Window.Create ("window")
      ...
      .Add_Part (layout1 = Am_Map.Create ("horizontal layout")
        ...
        .Set (Am_ITEM_PROTOTYPE,
	       layout_proto1 = Am_Rectangle.Create ("map item")
          .Set (Am_LINE_STYLE, Am_Black)
          .Set (Am_FILL_STYLE, map_fill)
          .Add (STAGGER, false)
      ...
      .Add_Part (layout2 = Am_Map.Create ("horizontal layout")
        ...
        .Set (Am_V_SPACING, 2)
        .Set (Am_ITEM_PROTOTYPE,
	       layout_proto2 = Am_Rectangle.Create ("map item")
          .Set (Am_LINE_STYLE, Am_Black)
          .Set (Am_FILL_STYLE, map_fill)
          .Add (STAGGER, false)
          .Set (Am_WIDTH, map_width)
