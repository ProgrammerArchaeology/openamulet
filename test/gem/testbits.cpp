...
#define IMFN_GREY "images/grey.gif"
#define IMFN_HI "images/hi.gif"
#define IMFN_SMILE "images/smile.gif"
#define IMFN_FUN "images/fun.gif"
#define IMFN_DIAMOND "images/diamond.gif"
#define IMFN_ENT "images/ent.gif"
#define IMFN_ENT_D "images/ent_d.gif"
#define IMFN_KLING "images/kling.gif"
#define IMFN_HAPPY "images/happy.gif"
#define IMFN_HAPPY_M "images/happy_m.gif"
#define IMFN_DS9 "images/ds9.gif"
#define IMFN_DS9_M "images/ds9_m.gif"
#define IMFN_BORG "images/borg.gif"
#define IMFN_BORG_M "images/borg_m.gif"
#define IMFN_CROSSHR "images/crsshr.gif"
#define IMFN_CROSSHR_M "images/crsshr_m.gif"
#define IMFN_ROM "images/rom.gif"
#define IMFN_ROM_M "images/rom_m.gif"
#define AMULET_GIF "images/Am_med.gif"
#else
// Unix names
#define IMFN_GREY "images/grey.xbm"
#define IMFN_HI "images/hi.xbm"
#define IMFN_SMILE "images/smile.xbm"
#define IMFN_FUN "images/fun.xbm"
#define IMFN_DIAMOND "images/diamond.xbm"
#define IMFN_ENT "images/ent.xbm"
#define IMFN_ENT_D "images/ent_d.xbm"
#define IMFN_KLING "images/kling.xbm"
#define IMFN_HAPPY "images/happy.xbm"
#define IMFN_HAPPY_M "images/happy_mask.xbm"
#define IMFN_DS9 "images/ds9.xbm"
#define IMFN_DS9_M "images/ds9_mask.xbm"
#define IMFN_BORG "images/borg.xbm"
#define IMFN_BORG_M "images/borg_mask.xbm"
#define IMFN_CROSSHR "images/crosshair.xbm"
#define IMFN_CROSSHR_M "images/crosshair_mask.xbm"
#define IMFN_ROM "images/rom.xbm"
#define IMFN_ROM_M "images/rom_mask.xbm"
#define AMULET_GIF "images/Am_med.gif"
#endif
...
void
test_bits(wins *wins_ar, int ar_len)
{

  for (int i = 0; i < ar_len; i++) {
    Am_Drawonable *the_bit_win = (wins_ar[i].root)->Create(100, 40, 255, 599);
    wins_ar[i].d1 = the_bit_win;
    wins_ar[i].d2 = the_bit_win->Create(0, 60, 110, 180);
    wins_ar[i].d3 =
        the_bit_win->Create(115, 60, 100, 100, "Opaque Stipple Test",
                            "Opaque Icon", true, false, white);
    wins_ar[i].d4 =
        the_bit_win->Create(0, 245, 251, 350, "Gemsd4 Am_Image_Array Test",
                            "Am_Image_Array", true, false, Am_Yellow);
