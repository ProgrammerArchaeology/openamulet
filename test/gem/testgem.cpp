...
init_wins()
{
  ...
  d5 = root->Create(TESTGEM_D5_LEFT, TESTGEM_D5_TOP, 300, 500,
                    "Testing Bounding Boxes", "Bboxes");
  d6 = root->Create(TESTGEM_D6_LEFT, TESTGEM_D6_TOP, 200, 200,
                    "Testing Fill Stipples", "Fill Stipples");
  //#if defined(_WINDOWS)
...
void
test_roundtangles(Am_Drawonable *d)
{
