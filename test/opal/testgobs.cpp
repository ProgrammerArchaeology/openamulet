...
Am_Style dash15 (0.0f, 0.0f, 0.0f, 8,   Am_CAP_BUTT, Am_JOIN_MITER, Am_LINE_ON_OFF_DASH,
		 dash15_list);
Am_Style dash8 (0.0f, 0.0f, 0.0f, 20,   Am_CAP_BUTT, Am_JOIN_MITER, Am_LINE_ON_OFF_DASH,
		dash8_list);
Am_Style dash20 (0.0f, 0.0f, 1.0f, 12,  Am_CAP_BUTT, Am_JOIN_MITER, Am_LINE_ON_OFF_DASH,
		 dash20_list);
...
void init_roundtangle_window () {

  roundtangle_window = Am_Window.Create ("roundtangle_window")
    .Set (Am_LEFT, 200)
    .Set (Am_TOP, 10)
    .Set (Am_WIDTH, 300)
    .Set (Am_HEIGHT, 320)
...
void init_bitmap_window () {
  ...
  Am_Object bitmap_group = Am_Group.Create ("bitmap_group")
...
void init_point_window () {
  ...
  point_window.Add_Part (triangle_polygon)
    .Add_Part (star_polygon);
...
int main ()
{
  ...
  font_window.Add_Part (inter = Am_One_Shot_Interactor
