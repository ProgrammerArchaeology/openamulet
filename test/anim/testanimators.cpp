...
Am_Define_No_Self_Formula(int, top_on_dog) { return (int)dog.Get(Am_TOP) - 5; }
...
Am_Object
make_color_rect(Am_Style &color)
{
...
Am_Define_No_Self_Formula(int, width_of_menu) { return menu.Get(Am_WIDTH); }
...
Am_Define_Formula(int, button_top_p_28)
{
  ...
  return (int)obj.Get(Am_TOP, Am_NO_DEPENDENCY) +
         (int)obj.Get(Am_HEIGHT, Am_NO_DEPENDENCY);
...
Am_Image_Array
read_pixmap(const char *initialname)
{
  Am_Image_Array icon;
  ...
  eye_icon =
      Am_Bitmap.Create("Eye_Icon")
          ...
          .Add_Part(WALKER,
                    anim7 =
                        Am_Animation_Interactor
                            ...
                            .Set_Part(Am_COMMAND,
                                      cmd = Am_Animation_Object_In_Owner_Command
                                                .Create("move_eye")
                                                .Set(Am_X_OFFSET, 4)
                                                .Set(Am_Y_OFFSET, 0)
          ...
          .Set(Am_IMAGE,
               Am_Animate_With(
                   change_pic_anim =
                       Am_Through_List_Animator.Create("change_eye_pict")
                           .Set(Am_LIST_OF_VALUES, which_way)
                           .Set_Part(Am_COMMAND,
                                     Am_Animation_Wrap_Command.Create())));
