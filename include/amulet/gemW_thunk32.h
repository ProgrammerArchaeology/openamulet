...
#define Am_Thunk_TextOut                                                       \
  ((Am_ThunkType_TextOut)GetProcAddress(m_hThunk32s, MAKEINTRESOURCE(1)))
#define Am_Thunk_GetTextExtentPoint32                                          \
  ((Am_ThunkType_GetTextExtentPoint32)GetProcAddress(m_hThunk32s,              \
                                                     MAKEINTRESOURCE(2)))
...
#define Am_Thunk_Ellipse                                                       \
  ((Am_ThunkType_Ellipse)GetProcAddress(m_hThunk32s, MAKEINTRESOURCE(4)))
