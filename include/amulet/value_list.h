...
public:
  ...
  Am_Value_List &Add(const char *value, Am_Add_Position position = Am_TAIL,
                     bool unique = true);
  Am_Value_List &Add(const Am_String &value, Am_Add_Position position = Am_TAIL,
                     bool unique = true);
  ...
  Am_Value_List &Add(Am_Generic_Procedure *value,
                     Am_Add_Position position = Am_TAIL, bool unique = true);
  Am_Value_List &Add(const Am_Value &value, Am_Add_Position position = Am_TAIL,
                     bool unique = true);
  ...
  void Insert(Am_Wrapper *value, Am_Insert_Position position,
              bool unique = true);
  void Insert(Am_Ptr value, Am_Insert_Position position, bool unique = true);
  void Insert(int value, Am_Insert_Position position, bool unique = true);
  void Insert(long value, Am_Insert_Position position, bool unique = true);
  void Insert(bool value, Am_Insert_Position position, bool unique = true);
  void Insert(float value, Am_Insert_Position position, bool unique = true);
  void Insert(double value, Am_Insert_Position position, bool unique = true);
  void Insert(char value, Am_Insert_Position position, bool unique = true);
