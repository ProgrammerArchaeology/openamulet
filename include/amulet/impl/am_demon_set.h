...
{
public:
  _OA_DL_MEMBERIMPORT Am_Object_Demon *
  Get_Object_Demon(Am_Object_Demon_Type type) const;
  void Set_Object_Demon(Am_Object_Demon_Type type, Am_Object_Demon *demon);

  _OA_DL_MEMBERIMPORT Am_Slot_Demon *
  Get_Slot_Demon(unsigned short which_bit) const;
  void Set_Slot_Demon(unsigned short which_bit, Am_Slot_Demon *method,
                      Am_Demon_Protocol protocol);

  _OA_DL_MEMBERIMPORT Am_Part_Demon *
  Get_Part_Demon(Am_Part_Demon_Type type) const;
  ...
  Am_Demon_Set(Am_Demon_Set_Data *in_data) { data = in_data; }

  _OA_DL_MEMBERIMPORT operator Am_Demon_Set_Data *() const { return data; }
