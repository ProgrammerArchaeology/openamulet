...
_OA_DL_IMPORT extern Am_Where_Method
    Am_Inter_In_Object_Or_Part; //default in interactors
...
_OA_DL_IMPORT extern Am_Where_Method
    Am_Inter_In_Text_Object_Or_Part; //default in text inter
_OA_DL_IMPORT extern Am_Where_Method
    Am_Inter_Not_In_Text_Object_Or_Part; //for text_create
_OA_DL_IMPORT extern Am_Where_Method Am_Inter_In_Text_Leaf;
_OA_DL_IMPORT extern Am_Where_Method
    Am_Inter_Not_In_Text_Leaf; //for text_create
