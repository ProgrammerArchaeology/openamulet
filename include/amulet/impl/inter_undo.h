...
_OA_DL_IMPORT extern Am_Object
    Am_Undo_Handler; // general, prototype undo handler obj
_OA_DL_IMPORT extern Am_Object
    Am_Single_Undo_Object; // can only undo last command
_OA_DL_IMPORT extern Am_Object
    Am_Multiple_Undo_Object; // can undo all top-level commands
...
_OA_DL_IMPORT extern Am_Selective_Allowed_Method
