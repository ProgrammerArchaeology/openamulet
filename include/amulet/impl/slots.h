...
enum Am_Standard_Slot_Keys
{
  ...
  Am_INTER_RUNNING_METHOD,
  Am_INTER_OUTSIDE_METHOD,
  Am_INTER_BACK_INSIDE_METHOD,
  Am_INTER_STOP_METHOD,
  Am_INTER_OUTSIDE_STOP_METHOD,
  Am_INTER_ABORT_METHOD,
  ...
  // choice interactor
  Am_HOW_SET,
  Am_FIRST_ONE_ONLY, // whether like button or menu
  ...
  Am_POINT_VALUE_1,
  Am_POINT_VALUE_2, //modified old and new point lists
  ...
  Am_SET_PROPERTY_INACTIVE,
  Am_CLEAR_INACTIVE,
  Am_COPY_INACTIVE,
  Am_CUT_INACTIVE,
  Am_DUPLICATE_INACTIVE,
  Am_TO_TOP_INACTIVE,
  Am_TO_BOTTOM_INACTIVE,
  Am_GROUP_INACTIVE,
  Am_UNGROUP_INACTIVE,
